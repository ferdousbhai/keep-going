...
```bash
codex plugin marketplace add ferdousbhai/stop-review --ref v0.2.0
...
```bash
npx --yes github:ferdousbhai/stop-review#v0.2.0 --claude
```

### Ghost

```bash
npx --yes github:ferdousbhai/stop-review#v0.2.0 --ghost
```
